    ...
    function AsideHeight() {
        ...
        $(window).resize(function() {
            if($(window).width() < 801) {
				...
				$(".menu-container").load("/Content/Template/menus/material-sidebar.html");
				...
				// ---------------------------------
					...
					$(".main-container").css('margin-top', containerMargin);
					$(".menu-container").load("Content/Template/menus/dropdown.html");
					var sidebar_width = 0;
			    }
				...
				// ---------------------------------
					...
					$(".main-container").css('margin-top', containerMargin);
					$(".menu-container").load("Content/Template/menus/megamenu.html");
					var sidebar_width = 0;
				...
				// ---------------------------------
					...
					$(".user-profile").load("menus/sidebar-user-profile.html");
					$(".menu-container").load("Content/Template/menus/iconic.html");

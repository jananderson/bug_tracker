...
namespace bug_tracker.Controllers
{
    ...
    public class TicketNotificationsController : Controller
    {
        ...
        {
            var ticketNotifications = db.Notifications.Include(t => t.Ticket).Include(t => t.Recipient);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Message,HasBeenRead")] TicketNotification ticketNotification)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "Title", ticketNotification.TicketId);
            ViewBag.UserId = new SelectList(db.Users, "Id", "FirstName", ticketNotification.Recipient);
            return View(ticketNotification);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Message,HasBeenRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {

...
namespace bug_tracker.Controllers
{
    ...
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Comment,TicketId")] TicketComment ticketComment)
        {
            ...
            try
            {
                ...
                msg.Body = "Your ticket has new comments." + Environment.NewLine + "Please click the following link for details " + "<a href=\"" + callbackUrl + "\">New Comment</a>";
